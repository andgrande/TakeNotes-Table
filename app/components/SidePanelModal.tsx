...
export default function SidePanelModal({ handleAddOnPage }: any) {
  ...
  return (
    ...
    >
      <div>
        <div className="fixed w-1/4 min-w-96 h-98% right-2 top-2 p-5 
        ...
        ">
          ...
          <div className="flex flex-col justify-between">
            <form id="oForm" onSubmit={handleSubmit} target="_blank" className='flex flex-col justify-between h-90vh w-full mt-4 space-y-0 -mb-4'>
